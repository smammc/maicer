  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-green-500 text-white p-3 sm:p-4 rounded-full shadow-lg hover:bg-green-600 transition-colors z-40"
        aria-label="WhatsApp"
      >
        <svg
